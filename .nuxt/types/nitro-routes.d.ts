...
declare module 'nitropack' {
  ...
  interface InternalApi {
    ...
    '/api/squad/buyPlayer': {
      'post': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/squad/buyPlayer.post').default>>>>
    }
    ...
    '/api/squadPlayers/:id': {
      'default': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/squadPlayers/[id]').default>>>>
    }
    '/api/team/:id': {

...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-a435f190.js").then((m) => m.default || m)
  },
  {
    name: "calendar",
    path: "/calendar",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-88456e55.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-8fdb81fe.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-169b4f8c.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-98bc40c8.js").then((m) => m.default || m)
  },
  {
    name: "player-A",
    path: "/player/A",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-ff5be874.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-7d6bbc08.js").then((m) => m.default || m)
  },
  {
    name: "player-C",
    path: "/player/C",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-d8926908.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-38b7e6ac.js").then((m) => m.default || m)
  },
  {
    name: "player-D",
    path: "/player/D",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-853e1bc8.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-6e9b93ff.js").then((m) => m.default || m)
  },
  {
    name: "player-P",
    path: "/player/P",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-af031bad.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-5c34d569.js").then((m) => m.default || m)
  },
  {
    name: "player-id",
    path: "/player/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-293271d3.js").then((m) => m.default || m)
  },
  {
    name: "player",
    path: "/player",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-c3ebdf5f.js").then((m) => m.default || m)
  },
  {
    name: "squad-id",
    path: "/squad/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-10d57438.js").then((m) => m.default || m)
  },
  {
    name: "team-id",
    path: "/team/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-8e360508.js").then((m) => m.default || m)
  },
  {
    name: "team",
    path: "/team",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-9507bfb3.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-c09702e5.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-404-f271fbc9.js").then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-500-d12c6993.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-c64bcb4c.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();

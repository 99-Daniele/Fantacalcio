import { reactive, hasInjectionContext, getCurrentInstance, toRef, isRef, inject, h, isReadonly, version, unref, ref, watchEffect, watch, isShallow, isReactive, toRaw, mergeProps, useSSRContext, defineAsyncComponent, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-404-a8f489e4.js").then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-500-f2715e45.js").then((r) => r.default || r));

globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://C:/Fantacalcio/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError } from 'file://C:/Fantacalcio/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file://C:/Fantacalcio/node_modules/vue-bundle-renderer/dist/runtime.mjs';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://C:/Fantacalcio/node_modules/ufo/dist/index.mjs';
...
const _lazy_zr3rz1 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_zr3rz1, lazy: true, middleware: false, method: undefined },
...
const getClientManifest = () => import('file://C:/Fantacalcio/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://C:/Fantacalcio/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
